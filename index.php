...
<body>
  ...
  <div id="title">
    <nav id="navbar" class="navbar navbar-expand-lg navbar-dark ">
      <a id="navbar-brand" href="index.php">Decade<span>  Bank</span></a>
  ...
  <div class="cont">
    <form action="">
      ...
      <button id="vhistory" class="btn btn-primary btn-lg btn-block " name="Transaction History"
        value="Transaction History" formaction="history.php">Transaction Details</button>
    </form>
  </div>
</body>
<footer id="footer">
  ...
  <p>©️ Copyright 2021 Decade Bank</p>
</footer>
